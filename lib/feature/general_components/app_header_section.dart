...
class APPHeaderSection extends StatefulWidget{
   const APPHeaderSection({Key? key,required this.selectedFunction}) : super(key: key);
...
class APPHeaderSectionState  extends State<APPHeaderSection>
{
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: AppSize.s50,
      child: Row(children: [
        Flexible(child: Container(width: MediaQuery.of(context).size.width/3,child: Center(child: Text(AppMessage.SYMBOL,style: AppTextStyles.bodyText1)))),
        Flexible(child: Container(width: MediaQuery.of(context).size.width/3,child: Center(child: Text(AppMessage.SYMBOL,style: AppTextStyles.bodyText1)))),
        Flexible(child: Container(width: MediaQuery.of(context).size.width/3,child: Center(child: Text(AppMessage.SYMBOL,style: AppTextStyles.bodyText1)))),
      ],),
    );
