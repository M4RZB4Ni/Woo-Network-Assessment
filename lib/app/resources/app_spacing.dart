...
class AppSpacing {
  ...
  static const EdgeInsets s12Horizontal = EdgeInsets.symmetric(horizontal: 12);
  static const EdgeInsets s12Vertical = EdgeInsets.symmetric(vertical: 12);
  static const EdgeInsets s35Top16Left16Right =
